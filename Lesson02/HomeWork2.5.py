...
5, 3, 3, 2. Пользователь ввел число 3. Результат: 7, 5, 3, 3, 3, 2. Пользователь ввел число 8. Результат: 8, 7, 5, 3,
3, 2. Пользователь ввел число 1. Результат: 7, 5, 3, 3, 2, 1.
...
while True:
    ...
    number = input('Введите целое число (или q для выхода) >>> ')
    if number.isdigit():
        number = int(number)
        my_list.append(number)
        my_list.sort(reverse=True) # Думаю что сортировка будет работать быстрее чем мой кустарный способ вставки
        # элемента на нужную позицию
    elif number == 'q':
        break
